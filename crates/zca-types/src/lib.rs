...
//!   regenerates the matching TypeScript at
//!   `packages/types/src/generated/contract.ts`.
//!
...
pub struct OAuthProvidersResponse {
    ...
    pub github: OAuthProviderStatus,
}
...
#[serde(rename_all = "camelCase")]
#[cfg_attr(feature = "ts", ts(rename_all = "camelCase"))]
pub struct OAuthDesktopVerifyRequest {
    pub code: String,
}
...
mod codegen {
    ...
    fn write_ts_contract() {
        let decls = [
            ...
            OAuthProviderStatus::decl(),
            OAuthProvidersResponse::decl(),
            OAuthDesktopVerifyRequest::decl(),
        ...
        let body = decls
            ...
            .join("\n\n");
        let contents = format!(
            "// AUTO-GENERATED by `cargo test --manifest-path crates/zca-types/Cargo.toml --features ts`. Do not edit by hand.\n\

...
```bash
node .kiro/skills/orchestrate/orchestrate.mjs "task description" --pattern=fanout
node .kiro/skills/orchestrate/orchestrate.mjs "task description" --pattern=fanout --run --max-concurrency=3
node .kiro/skills/orchestrate/orchestrate.mjs "task description" --pattern=fanout --run --transport=mock
node .kiro/skills/orchestrate/orchestrate.mjs "task description" --pattern=fanout --run --transport=codex-cli
node .harness/scripts/orchestration-contract-from-task.mjs <task-id>
node .kiro/skills/orchestrate/orchestrate.mjs --contract=release-review --run --transport=mock
node .kiro/skills/orchestrate/orchestrate.mjs --resume=<run-id-or-dir>
node .kiro/skills/orchestrate/orchestrate.mjs --validate-run=<run-id-or-dir>
```
